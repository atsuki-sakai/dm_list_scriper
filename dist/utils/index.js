...
exports.extractPrefectureAndCity = extractPrefectureAndCity;
exports.generateLocationBasedSearchQuery = generateLocationBasedSearchQuery;
...
function calculateRelevanceScore(salonName, candidate) {
    ...
    if (candidate.includes('instagram.com')) {
        const { calculateInstagramRelevance } = require('../services/instagramExtractor');
 ...
 * @returns 最適化された検索クエリ
 */
function generateLocationBasedSearchQuery(salonName, address) {
    // サロン名の整理
